module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('cover' in setting)) setting.cover = 'https://express-uploader.dapitt.repl.co/file/6PUwI71gRzdu.jpg'
      ...
      if (!('footer' in setting)) setting.footer = 'ᴏɴᴇ ʙᴏᴛᴢ ʙʏ ᴅᴀᴠɪᴅ ッ'
   } else {
      global.db.setting = {
         autobackup: false,
         backupTime: 36000,
         ...
         sk_pack: 'O͟n͟e͟ B͟o͟t͟Z͟ ',
         sk_author: '',
         multiprefix: true,
         prefix: ['.', '#', '!', '/'],
         onlyprefix: '+',
         owners: ['6282160268332'],
         cover: 'https://express-uploader.dapitt.repl.co/file/6PUwI71gRzdu.jpg',
         header: 'JUST FOR FUN',
         msg: 'I am a Whatsapp BOT, use a bot in private chat so that bots can respond quickly.',
         footer: 'ᴏɴᴇ ʙᴏᴛᴢ ʙʏ ᴅᴀᴠɪᴅ ッ'
      }
   }
}